...
List<Movie> movies = [
  Movie(
      ...
      imageUrl: 'assets/moviebg/joker.jpg',
      rating: 9.0,
      genres: ['Crime', 'Drama'],
      cast: [
        Actor(name: 'Joaquin Pheonix', imageUrl: 'assets/moviebg/user6.jpg'),
        Actor(name: 'Robert De Niro', imageUrl: 'assets/moviebg/user5.jpg'),
        Actor(name: 'Zazie Beetz', imageUrl: 'assets/moviebg/user3.jpg'),
        Actor(name: 'Frances Conroy', imageUrl: 'assets/moviebg/user8.jpg')
      ],
      description:
  ...
  Movie(
      ...
      imageUrl: 'assets/moviebg/hustle.jpg',
      rating: 9.0,
      genres: ['Crime', 'Thriller'],
      cast: [
        Actor(name: 'Rebel Wilson', imageUrl: 'assets/moviebg/user1.jpg'),
        Actor(name: 'Anne Hathaway', imageUrl: 'assets/moviebg/user2.jpg'),
        Actor(name: 'Alex Sharp', imageUrl: 'assets/moviebg/user7.jpg'),
        Actor(name: 'Ingrid Oliver', imageUrl: 'assets/moviebg/user4.jpg')
      ],
      description:
  ...
  Movie(
      ...
      imageUrl: 'assets/moviebg/good_boys.jpg',
      rating: 9.0,
      genres: ['Adventure', 'Comedy'],
      cast: [
        Actor(name: 'Jacob Tremblay', imageUrl: 'assets/moviebg/user5.jpg'),
        Actor(name: 'Keith L Williams', imageUrl: 'assets/moviebg/user6.jpg'),
        Actor(name: 'Brady Noon', imageUrl: 'assets/moviebg/user8.jpg'),
        Actor(name: 'Molly Gordon', imageUrl: 'assets/moviebg/user4.jpg')
      ],
      description:
  ...
  Movie(
      ...
      stars: 4,
      imageUrl: 'assets/moviebg/hollywood.jpg',
      rating: 9.0,
      genres: ['Comedy', 'Drama'],
      cast: [
        Actor(name: 'Brad Pitt', imageUrl: 'assets/moviebg/user6.jpg'),
        Actor(name: 'Leonardo DiCaprio', imageUrl: 'assets/moviebg/user7.jpg'),
        Actor(name: 'Margot Robbie', imageUrl: 'assets/moviebg/user3.jpg'),
        Actor(name: 'Dakota Fanning', imageUrl: 'assets/moviebg/user4.jpg')
      ],
      description:
